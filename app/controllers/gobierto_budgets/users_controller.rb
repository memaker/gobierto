module GobiertoBudgets
  class UsersController < ApplicationController
    ...
    def new
      redirect_to edit_gobierto_budgets_user_path if logged_in?
    ...
    def identify
      @user = User.find_or_initialize_by email: params[:gobierto_budgets_user][:email]
      if @user.new_record?
    ...
    def create_user_params
      params.require(:gobierto_budgets_user).permit(:first_name, :last_name, :email, :place_id, :pro, :terms_of_service)
    end

    def update_user_params
      params.require(:gobierto_budgets_user).permit(:first_name, :last_name, :email, :password, :password_confirmation, :current_password, :place_id, :pro, :terms_of_service)
    end

    def load_current_user
      redirect_to gobierto_budgets_login_path and return unless logged_in?
