class User < ActiveRecord::Base
  ...
  has_many :ideas, class_name: GobiertoParticipation::Idea, dependent: :destroy
  has_many :consultations, class_name: GobiertoParticipation::Consultation, dependent: :destroy
  has_many :answers, class_name: GobiertoParticipation::ConsultationAnswer, dependent: :destroy
  has_many :comments, class_name: GobiertoParticipation::Comment, dependent: :destroy
